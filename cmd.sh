...
sleep 16
echo "readiness live? $(grep -c 'dashboard SPA' scraper/axa/quote-service.mjs)$(grep -c 'non pronto' scraper/axa/quote-service.mjs)  axa=$(systemctl is-active axa-scraper.service)/R$(systemctl show axa-scraper.service -p NRestarts --value)"
